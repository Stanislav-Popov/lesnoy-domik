...
function HomePage() {
    ...
    return (
        <main>
            <SchemaOrg />
            <SEO
                title="Аренда загородного дома посуточно в Новой Москве"
                description="Снять загородный дом «Лесной домик» посуточно. До 60 гостей, 6 спален, русская баня, зона барбекю. Для праздников, корпоративов, выходных с друзьями. Деревня Мешково, 30 мин от МКАД."
                canonical="/"
            />
                ...
                <div className="container">
                    ...
                    <div className="about-grid">
                        ...
                        <div className="about-grid__text">
                            ...
                            <p>
                                «Лесной домик» — загородный дом для аренды посуточно, идеальный для отдыха в
                                кругу семьи, друзей или проведения мероприятий: дней рождения, корпоративов,
                                свадеб и тимбилдингов.
                            </p>
                            <p>
                                Дом расположен в деревне Мешково, Новомосковский округ Москвы — всего 30 минут
                                от МКАД. Рядом лесопарк, пруд для купания и рыбалки. Магазины и аптеки в пешей
                                доступности.
                            </p>
                            <p>
                                На первом этаже — просторный зал с большим столом до 60 человек, оборудованная
                                кухня, телевизор, караоке и гитара. На втором — 6 спальных комнат, детская
                                комната, зона отдыха с настольным теннисом, футболом и хоккеем. Рядом —
                                отдельный домик с русской баней.
                            </p>
                    ...
                    <div className="features-grid">
                        {[
                            ...
                            },
                            {
                                emoji: "☀️",
                                title: "Зона отдыха",
                                desc: "Караоке, гитара, настольный теннис, настольный футбол и настольный хоккей",
                            },
                            {
                                emoji: "🌲",
                                title: "Природа",
                                desc: "Рядом с домом — лесопарк, ведущий в город Московский, и пруд, где можно купаться и рыбачить",
                            },
                            {
                                emoji: "🔥",
                                title: "Русская баня",
                                desc: "Рядом с основным домом находится отдельный домик с баней",
                            },
                        ].map((item, i) => (
                        ...
                        {[
                            {
                                ...
                                text: "Просторный зал на первом этаже с большим столом до 60 человек — идеальное место для праздников и мероприятий. Телевизор, караоке и гитара для весёлого времяпровождения. На втором этаже — отдельная комната отдыха с настольным теннисом, настольным футболом и настольным хоккеем.",
                            },
                            {
                                img: "/images/grill-1.webp",
                                title: "Русская баня",
                                text: "Рядом с основным домом расположен отдельный домик с баней. После бани — прогулка к ближайшему пруду, где можно искупаться, или отдых на свежем воздухе в окружении природы и тишины.",
                            },
                            {
                                img: "/images/grill-3.webp",
                                title: "Терраса и барбекю",
                                text: "Большая оборудованная кухня на первом этаже со всем необходимым для приготовления еды. На территории — зона барбекю на свежем воздухе. Весной планируется строительство бассейна, детской площадки и оборудованной зоны отдыха у костра.",
                            },
                        ].map((item, i) => (
                ...
                <div className="container" style={{ textAlign: "center" }}>
                    ...
                    <div className="contacts-grid">
                        ...
                        <div className="contact-card">
                            ...
                            <strong>
                                деревня Мешково, 173, Филимонковский район, Новомосковский административный
                                округ, Москва
                            </strong>
                        </div>
                    </div>
