                ...
                <div className="container">
                    ...
                    <div className="about-grid">
                        ...
                        <div className="about-grid__text">
                            ...
                            <p>
                                «Лесной домик» — просторный загородный дом для отдыха в кругу семьи, друзей и
                                проведения праздников или мероприятий. Дом находится в тихом живописном месте
                                рядом с лесопарком, ведущим в город Московский.
                            </p>
                            <p>
                                Вся необходимая инфраструктура — магазины, аптеки и транспорт — в пешей
                                доступности. Неподалёку расположен пруд, где можно купаться, рыбачить или
                                просто наслаждаться природой и тишиной. Рядом с домом также находится
                                отдельный домик с баней.
                            </p>
                            <p>
                                На первом этаже — просторный зал с большим столом до 60 человек, оборудованная
                                кухня, телевизор, караоке и гитара. На втором — 6 спальных комнат, комната с
                                детскими кроватями, комната отдыха, настольный теннис, настольный футбол и
                                настольный хоккей.
                            </p>
